    ...
    <>
      <form className="flex pl-2 w-full font-body">
        <div className="flex flex-grow rounded-sm shadow-md">
          <div className="flex flex-grow items-center text-black bg-white rounded-md">
            ...
            <input
              ...
              md:text-md sm:text-md w-full pl-14 py-3 pr-2 p rounded-lg overflow-hidden focus-within:shadow-none outline-none sm:items-center text-black"
      ...
      {searchText.length > 0 ? (
        ...
        id="searchbar"
          ...
          overflow-x-hidden py-2 bg-white bg-opacity-60 overflow-scroll scrollbar-thin
...
export const SearchBar = () => {
  ...
  return (
    <>
      <div data-testid="Searchbar_1" className="flex">
        <span className="flex shadow-md rounded-lg">
          <select
            value={currency}
            onChange={handleCurrency}
            ref={currencyRef}
            className="outline-none font-body pr-3 pl-2 rounded-lg w-[90px] md:w-[90px] sm:w-[90px] cursor-pointer bg-white"
          >

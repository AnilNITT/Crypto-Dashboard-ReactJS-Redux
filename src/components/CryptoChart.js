...
const CryptoChart = () => {
    ...
    return (
      <div className="container-fluid w-full h-96 border  bg-white  backdrop-blur-md my-5 rounded-lg shadow-sm px-4 pt-3 lg:mt-3">
        
        <div className="text-black flex py-0 pt-20 ml-4 absolute text-md font-semibold">
            {currency.toUpperCase()}
          </div>
        <div className="flex lg:gap-3 sm:gap-0 absolute items-center lg:ml-48 md:ml-16 sm:ml-28 ml-16 gap-2 lg:left-34 left-4 md:mt-3 lg:mt-3 sm:mt-3 mt-3">
  
          <button
            value={1}
            className={`px-3 py-1.5 ${
              days === 1 ? " border-blue-600 border text-blue-600 bg-blue-300" : ""
            } rounded-md text-xs text-black bg-gray-400 hover:bg-gray-200 bg-opacity-30 backdrop-blur-md font-semibold lg:mt-2`}
            onClick={oneDay}
          >
            1D
          </button>
          ...
          <button
            ...
            onClick={oneWeek}
            className={`px-3 py-1.5 ${
              days === 7 ? " border-blue-600 border text-blue-600 bg-blue-300" : ""
            } rounded-md text-xs bg-gray-400 hover:bg-gray-200  font-semibold lg:mt-2 text-black bg-opacity-30 backdrop-blur-md`}
          >
            1W
          </button>
          <button
            ...
            onClick={oneMonth}
            className={`px-3 py-1.5 ${
              days === 30 ? " border-blue-600 border text-blue-600 bg-blue-300" : ""
            } rounded-md text-xs bg-gray-400 hover:bg-gray-200 font-semibold lg:mt-2 text-black bg-opacity-30 backdrop-blur-md`}
          >
            1M
          </button>
          <button
            ...
            onClick={sixMonths}
            className={`px-3 py-1.5 ${
              days === 180 ? " border-blue-600 border text-blue-600 bg-blue-300" : ""
            } rounded-md text-xs bg-gray-400 hover:bg-gray-200 font-semibold lg:mt-2 text-black bg-opacity-30 backdrop-blur-md`}
            >
            6M
          </button>
          <button
            ...
            onClick={oneYear}
            className={`px-3 py-1.5 ${
              days === 365 ? " border-blue-600 border text-blue-600 bg-blue-300" : ""
            } rounded-md text-xs bg-gray-400 hover:bg-gray-200 font-semibold lg:mt-2 text-black bg-opacity-30 backdrop-blur-md`}
          >
            1Y
          </button>
          {/* this menu contains cryptocurrencies */}
          <div className="flex absolute items-center rounded-md bg-gray-400 text-black bg-opacity-30 backdrop-blur-md p-2 w-24 lg:left-[16rem] lg:mt-4 md:left-[25rem] md:mt-4 sm:right-[9rem] mt-20 ml-2">
            <select
              onChange={(e) => {
            ...
            <div className="rounded-md bg-gray-400 bg-opacity-30 backdrop-blur-md text-black p-2 absolute lg:left-[6rem] md:left-[6rem] left-[6rem] w-28 ml-5">
              <select
